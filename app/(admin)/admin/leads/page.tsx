            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-secondary/50">
                  <TableHead className="w-[120px] py-4 pl-6">ID</TableHead>
                  ...
                  <TableHead className="hidden lg:table-cell py-4">Created</TableHead>
                  <TableHead className="w-[80px] py-4 pr-6">Actions</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {paginatedLeads.map((lead) => (
                  <TableRow key={lead.id} className="hover:bg-accent/50 group cursor-pointer transition-colors" onClick={() => router.push(`/admin/leads/${lead.id}`)}>
                    <TableCell className="font-medium text-primary py-4 pl-6">
                    ...
                    <TableCell className="py-4">{lead.source || "—"}</TableCell>
                    <TableCell className="hidden lg:table-cell text-muted-foreground text-sm py-4">
